...
import styles from './StepConfirmWithdrawFromRetirement.css';

const cx = classNames.bind(styles);

const StepConfirmWithdrawFromRetirement = ({ onSubmit, onClickPrevPage }) => (
  <div className={cx('StepConfirmWithdrawFromRetirement')}>
...
StepConfirmWithdrawFromRetirement.displayName = 'StepConfirmWithdrawFromRetirement';

StepConfirmWithdrawFromRetirement.propTypes = {
  onSubmit: PropTypes.func.isRequired,
  onClickPrevPage: PropTypes.func.isRequired,
};

StepConfirmWithdrawFromRetirement.defaultProps = {};

export default StepConfirmWithdrawFromRetirement;
